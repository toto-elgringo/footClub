...
class FootballMatch {
    ...
    public function getOpposingClubId(): ?int { return $this->opposingClubId; }

    public function setId(?int $id): void { $this->id = $id; }
    public function setDate(DateTime $date): void { $this->date = $date; }
    public function setCity(string $city): void { $this->city = $city; }
    public function setTeamScore(int $teamScore): void { $this->teamScore = $teamScore; }
    public function setOpponentScore(int $opponentScore): void { $this->opponentScore = $opponentScore; }
    public function setTeamId(int $teamId): void { $this->teamId = $teamId; }
    public function setOpposingClubId(?int $opposingClubId): void { $this->opposingClubId = $opposingClubId; }
}
